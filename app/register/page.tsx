...
export default function RegisterPage() {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-gray-50">
      ...
      {/* LEFT SIDE - Branding */}
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 flex-col justify-between p-10 text-white relative">
      ...
      <div className="w-full lg:w-1/2 h-full flex items-center justify-center p-4 overflow-y-auto">
        ...
        <div className="w-full max-w-lg bg-white p-6 sm:p-8 rounded-2xl shadow-xl border border-gray-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            required
                            // UPDATE: Placeholder lebih jelas agar tidak disingkat
                ...
                {/* Checkbox Syarat & Ketentuan DIHAPUS */}
